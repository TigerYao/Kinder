    ...
    public void getImgs() {
        Observable.OnSubscribe<ArrayList<ImageInfo>> subscribe = new Observable.OnSubscribe<ArrayList<ImageInfo>>() {
            ...
            public void call(Subscriber<? super ArrayList<ImageInfo>> subscriber) {
                ...
                Cursor c = MediaStore.Images.Media.query(getContentResolver(), baseUri, new String[]{MediaStore.Images.Media._ID, MediaStore.Images.Media.DATA, MediaStore.Images.Media.DISPLAY_NAME});
